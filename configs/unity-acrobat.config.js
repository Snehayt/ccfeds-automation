 ...
 */
const config = {
  testDir: '../tests/cc/unity-acrobat',
  ...
  projects: [
    ...
    {
      name: 'unity-acrobat-firefox',
      use: { ...devices['Desktop Firefox'] },
    },

    {
      name: 'unity-acrobat-webkit',
      use: { ...devices['Desktop Safari'] },
    },

    {
      name: 'unity-acrobat-IOS-mobile',
      use: {
        ...devices['iPhone 15'],
        userAgent:
    ...
    {
      name: 'unity-acrobat-Android-mobile',
      use: {
        ...devices['Galaxy S24'],
        userAgent:
