...
import { features } from '../../../features/cc/unity-acrobat/heic-to-pdf.spec.js';
...
test.describe('Acrobat HeicToPdf Unity Widget', () => {
  ...
  test(`${features[1].name}, ${features[1].tags}`, async ({ page, baseURL }) => {
    ...
    await test.step('Select sample file from assets', async () => {
      const originalUrl = features[1].path;
  ...
  test(`${features[2].name}, ${features[2].tags}`, async ({ page, baseURL }) => {
    console.info(`[Test Page]: ${features[2].path}`);
